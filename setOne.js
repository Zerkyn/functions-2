...
//     for (let i = 0; i < arr.length; i++) {
//         if (arr[i].color === 'purple') {
//             return console.log(`The fruit with index ${arr.indexOf(arr[i])}`)
//         }
//     }
// }
...
// CODE HERE
const parameters1And2 = (parameter1, parameter2) => console.log(`The first parameter is ${parameter1}. the second parameter is ${parameter2}`)

// INVOKE THE FUNCTION HERE. THE PARAMETERS TAKE ANY DATATYPE.
// console.log(parameters1And2('beep', 'boop'))
...
const greetingCallback = (name) => console.log(`Hello, my full name is ${name}`)
...
greeting('Ryan', 'Morgan', greetingCallback)
...
const totalPrice = (arr) => {
    console.log(`the new array plus tax = ${arr}`)
}
...
// CODE HERE
pricesPlusTax(prices, totalPrice)
...
const multiplyingFactory = (num) => {
    return function inner(num2) {
        ...
        } else console.log(`cannot multiply the first number is smaller than 5`)
    }
}
/*
